<!DOCTYPE html>
<html lang="en" class="scroll-smooth {{ request()->routeIs('landing') ? '' : 'intro-complete reveal-ui' }}">
<head>
    <meta charset="UTF-8">
        ...
        >
            <nav class="mx-auto flex max-w-7xl items-center justify-between px-5 py-2.5 lg:px-8 relative">
                ...
                <div class="hidden items-center lg:flex relative h-10 w-64 justify-end">
                    ...
                    <a
                        href="{{ route('home') }}"
                        class="site-header-skip ghost-button rounded px-4 py-2 text-[.68rem] flex items-center justify-center"
                    >
                        Skip intro
                    </a>
                    @endif
                ...
                <div class="flex items-center lg:hidden relative h-10 w-24 justify-end">
                    ...
                    <a
                        href="{{ route('home') }}"
                        class="site-header-skip ghost-button mr-2 rounded px-3 py-1.5 text-[.6rem] flex items-center justify-center"
                    >
                        Skip
                    </a>
                    @endif
